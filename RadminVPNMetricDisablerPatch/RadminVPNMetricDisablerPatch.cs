...
namespace Invertex.RadminVPNMetricDisablerPatch
{
    class RadminVPNMetricDisablerPatch
    {
        static int Main(string[] args)
        {
            ...
            string path = "C:\\Program Files\\Radmin VPN\\RvControlSvc.exe";
            string path2 = "C:\\Program Files (x86)\\Radmin VPN\\RvControlSvc.exe";
            ...
            string replaceString = "6E 00 65 00 74 00 73 00 68 00 20 00 69 00 6E 00 74 00 65 00 72 00 66 00 61 00 63 00 65 00 20 00 69 00 70 00 76 00 34 00 20 00 73 00 65 00 74 00 20 00 69 00 6E 00 74 00 65 00 72 00 66 00 61 00 63 00 65 00 20 00 69 00 6E 00 74 00 65 00 72 00 66 00 61 00 63 00 65 00 3D 00 22 00 25 00 6C 00 73 00 22 00 20 00 6D 00 65 00 74 00 72 00 69 00 63 00 00 00 00 00 00";
